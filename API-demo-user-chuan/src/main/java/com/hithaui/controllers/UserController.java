...
public class UserController {
	...
	{
		UserDAO oldUserDAO = userRepository.findByEmail(userDTO.getEmail());
		oldUserDAO = userRepository.findByPhoneNumber(userDTO.getPhoneNumber());
		oldUserDAO = userRepository.findByUserName(userDTO.getUserName());
		if(oldUserDAO != null)
		{
